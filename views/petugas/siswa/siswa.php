            ...
            ?>
             <tr>
                ...
                <td>
                    ...
                    <a href="routes/proses.php?act=hapus_siswa&id=<?=$u->siswa_id?>" class='btn btn-danger' onclick='return confirm("Apakah anda ingin menghapus data ini?")'>Hapus</a>
                </td>
            </tr>
            <?php
    }
