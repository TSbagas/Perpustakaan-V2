      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <span class="text-white btn btn-outline-light">Welcome , <?=$_SESSION['username'];?> </span>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  ...
                  <p class="mb-0 text-bold"><?=$data->menghitung_users();?></p>
                </div>
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <p class="text-sm mb-0 text-uppercase font-weight-bold">Jumlah Siswa</p>
                  <p class="mb-0 text-bold"><?=$data->menghitung_siswa();?></p>
                </div>
                <div class="col-4 text-end">
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <p class="text-sm mb-0 text-uppercase font-weight-bold">Jumlah Buku</p>
                  <p class="mb-0 text-bold"><?=$data->menghitung_buku();?></p>
                </div>
                <div class="col-4 text-end">
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <p class="text-sm mb-0 text-uppercase font-weight-bold">Peminjaman</p>
                  <p class="mb-0 text-bold"><?=$data->menghitung_peminjaman();?></p>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Perpustakaan Mini V2</a>
              </div>
            </div>
          </div>
        </div>
